...
if TYPE_CHECKING:
    from ..models.create_call_summary_webhook_v1_response_400_errors_item import (
        CreateCallSummaryWebhookV1Response400ErrorsItem,
    )


T = TypeVar("T", bound="CreateCallSummaryWebhookV1Response400")


@_attrs_define
class CreateCallSummaryWebhookV1Response400:
    """
    Attributes:
        message (str):
        ...
        errors (Union[Unset, list['CreateCallSummaryWebhookV1Response400ErrorsItem']]):
    """
    ...
    errors: Union[Unset, list["CreateCallSummaryWebhookV1Response400ErrorsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for errors_item_data in _errors or []:
            errors_item = CreateCallSummaryWebhookV1Response400ErrorsItem.from_dict(errors_item_data)

            errors.append(errors_item)

        create_call_summary_webhook_v1_response_400 = cls(
            message=message,
            code=code,
            status=status,
            docs=docs,
        ...
        create_call_summary_webhook_v1_response_400.additional_properties = d
        return create_call_summary_webhook_v1_response_400
