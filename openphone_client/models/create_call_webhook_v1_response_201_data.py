...
from ..models.create_call_webhook_v1_response_201_data_events_item import CreateCallWebhookV1Response201DataEventsItem
from ..models.create_call_webhook_v1_response_201_data_status import CreateCallWebhookV1Response201DataStatus

T = TypeVar("T", bound="CreateCallWebhookV1Response201Data")


@_attrs_define
class CreateCallWebhookV1Response201Data:
    """
    Attributes:
        ...
        status (CreateCallWebhookV1Response201DataStatus): The status of the webhook. Default:
            CreateCallWebhookV1Response201DataStatus.ENABLED.
        ...
        events (list[CreateCallWebhookV1Response201DataEventsItem]):
    ...
    events: list[CreateCallWebhookV1Response201DataEventsItem]
    resource_ids: Union[list[Literal["*"]], list[str]]
    status: CreateCallWebhookV1Response201DataStatus = CreateCallWebhookV1Response201DataStatus.ENABLED
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = CreateCallWebhookV1Response201DataStatus(d.pop("status"))
        ...
        for events_item_data in _events:
            events_item = CreateCallWebhookV1Response201DataEventsItem(events_item_data)
        ...
        create_call_webhook_v1_response_201_data = cls(
            id=id,
            user_id=user_id,
            org_id=org_id,
            label=label,
        ...
        create_call_webhook_v1_response_201_data.additional_properties = d
        return create_call_webhook_v1_response_201_data
