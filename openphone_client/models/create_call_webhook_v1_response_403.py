...
if TYPE_CHECKING:
    from ..models.create_call_webhook_v1_response_403_errors_item import CreateCallWebhookV1Response403ErrorsItem


T = TypeVar("T", bound="CreateCallWebhookV1Response403")


@_attrs_define
class CreateCallWebhookV1Response403:
    """
    Attributes:
        message (str):
        ...
        errors (Union[Unset, list['CreateCallWebhookV1Response403ErrorsItem']]):
    """
    ...
    errors: Union[Unset, list["CreateCallWebhookV1Response403ErrorsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for errors_item_data in _errors or []:
            errors_item = CreateCallWebhookV1Response403ErrorsItem.from_dict(errors_item_data)

            errors.append(errors_item)

        create_call_webhook_v1_response_403 = cls(
            message=message,
            code=code,
            status=status,
            docs=docs,
        ...
        create_call_webhook_v1_response_403.additional_properties = d
        return create_call_webhook_v1_response_403
