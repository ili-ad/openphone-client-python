...
from ..models.create_message_webhook_v1_response_201_data_events_item import (
    CreateMessageWebhookV1Response201DataEventsItem,
)
from ..models.create_message_webhook_v1_response_201_data_status import CreateMessageWebhookV1Response201DataStatus

T = TypeVar("T", bound="CreateMessageWebhookV1Response201Data")


@_attrs_define
class CreateMessageWebhookV1Response201Data:
    """
    Attributes:
        ...
        status (CreateMessageWebhookV1Response201DataStatus): The status of the webhook. Default:
            CreateMessageWebhookV1Response201DataStatus.ENABLED.
        ...
        events (list[CreateMessageWebhookV1Response201DataEventsItem]):
    ...
    events: list[CreateMessageWebhookV1Response201DataEventsItem]
    resource_ids: Union[list[Literal["*"]], list[str]]
    status: CreateMessageWebhookV1Response201DataStatus = CreateMessageWebhookV1Response201DataStatus.ENABLED
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = CreateMessageWebhookV1Response201DataStatus(d.pop("status"))
        ...
        for events_item_data in _events:
            events_item = CreateMessageWebhookV1Response201DataEventsItem(events_item_data)
        ...
        create_message_webhook_v1_response_201_data = cls(
            id=id,
            user_id=user_id,
            org_id=org_id,
            label=label,
        ...
        create_message_webhook_v1_response_201_data.additional_properties = d
        return create_message_webhook_v1_response_201_data
