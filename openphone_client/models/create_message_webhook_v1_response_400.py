...
if TYPE_CHECKING:
    from ..models.create_message_webhook_v1_response_400_errors_item import CreateMessageWebhookV1Response400ErrorsItem


T = TypeVar("T", bound="CreateMessageWebhookV1Response400")


@_attrs_define
class CreateMessageWebhookV1Response400:
    """
    Attributes:
        message (str):
        ...
        errors (Union[Unset, list['CreateMessageWebhookV1Response400ErrorsItem']]):
    """
    ...
    errors: Union[Unset, list["CreateMessageWebhookV1Response400ErrorsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.create_message_webhook_v1_response_400_errors_item import (
        ...
        for errors_item_data in _errors or []:
            errors_item = CreateMessageWebhookV1Response400ErrorsItem.from_dict(errors_item_data)

            errors.append(errors_item)

        create_message_webhook_v1_response_400 = cls(
            message=message,
            code=code,
            status=status,
            docs=docs,
        ...
        create_message_webhook_v1_response_400.additional_properties = d
        return create_message_webhook_v1_response_400
