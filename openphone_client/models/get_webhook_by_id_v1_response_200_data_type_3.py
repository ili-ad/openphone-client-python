...
from ..models.get_webhook_by_id_v1_response_200_data_type_3_events_item import (
    GetWebhookByIdV1Response200DataType3EventsItem,
)
from ..models.get_webhook_by_id_v1_response_200_data_type_3_status import GetWebhookByIdV1Response200DataType3Status

T = TypeVar("T", bound="GetWebhookByIdV1Response200DataType3")


@_attrs_define
class GetWebhookByIdV1Response200DataType3:
    """
    Attributes:
        ...
        status (GetWebhookByIdV1Response200DataType3Status): The status of the webhook. Default:
            GetWebhookByIdV1Response200DataType3Status.ENABLED.
        ...
        events (list[GetWebhookByIdV1Response200DataType3EventsItem]):
    ...
    events: list[GetWebhookByIdV1Response200DataType3EventsItem]
    resource_ids: Union[list[Literal["*"]], list[str]]
    status: GetWebhookByIdV1Response200DataType3Status = GetWebhookByIdV1Response200DataType3Status.ENABLED
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = GetWebhookByIdV1Response200DataType3Status(d.pop("status"))
        ...
        for events_item_data in _events:
            events_item = GetWebhookByIdV1Response200DataType3EventsItem(events_item_data)
        ...
        get_webhook_by_id_v1_response_200_data_type_3 = cls(
            id=id,
            user_id=user_id,
            org_id=org_id,
            label=label,
        ...
        get_webhook_by_id_v1_response_200_data_type_3.additional_properties = d
        return get_webhook_by_id_v1_response_200_data_type_3
