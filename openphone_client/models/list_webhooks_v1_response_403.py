...
if TYPE_CHECKING:
    from ..models.list_webhooks_v1_response_403_errors_item import ListWebhooksV1Response403ErrorsItem


T = TypeVar("T", bound="ListWebhooksV1Response403")


@_attrs_define
class ListWebhooksV1Response403:
    """
    Attributes:
        message (str):
        ...
        errors (Union[Unset, list['ListWebhooksV1Response403ErrorsItem']]):
    """
    ...
    errors: Union[Unset, list["ListWebhooksV1Response403ErrorsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for errors_item_data in _errors or []:
            errors_item = ListWebhooksV1Response403ErrorsItem.from_dict(errors_item_data)

            errors.append(errors_item)

        list_webhooks_v1_response_403 = cls(
            message=message,
            code=code,
            status=status,
            docs=docs,
        ...
        list_webhooks_v1_response_403.additional_properties = d
        return list_webhooks_v1_response_403
