...
if TYPE_CHECKING:
    from ..models.list_webhooks_v1_response_404_errors_item import ListWebhooksV1Response404ErrorsItem


T = TypeVar("T", bound="ListWebhooksV1Response404")


@_attrs_define
class ListWebhooksV1Response404:
    """
    Attributes:
        message (str):
        ...
        errors (Union[Unset, list['ListWebhooksV1Response404ErrorsItem']]):
    """
    ...
    errors: Union[Unset, list["ListWebhooksV1Response404ErrorsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for errors_item_data in _errors or []:
            errors_item = ListWebhooksV1Response404ErrorsItem.from_dict(errors_item_data)

            errors.append(errors_item)

        list_webhooks_v1_response_404 = cls(
            message=message,
            code=code,
            status=status,
            docs=docs,
        ...
        list_webhooks_v1_response_404.additional_properties = d
        return list_webhooks_v1_response_404
