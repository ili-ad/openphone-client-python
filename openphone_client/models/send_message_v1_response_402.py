...
if TYPE_CHECKING:
    from ..models.send_message_v1_response_402_errors_item import SendMessageV1Response402ErrorsItem


T = TypeVar("T", bound="SendMessageV1Response402")


@_attrs_define
class SendMessageV1Response402:
    """
    Attributes:
        message (str):
        ...
        errors (Union[Unset, list['SendMessageV1Response402ErrorsItem']]):
    """
    ...
    errors: Union[Unset, list["SendMessageV1Response402ErrorsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for errors_item_data in _errors or []:
            errors_item = SendMessageV1Response402ErrorsItem.from_dict(errors_item_data)

            errors.append(errors_item)

        send_message_v1_response_402 = cls(
            message=message,
            code=code,
            status=status,
            docs=docs,
        ...
        send_message_v1_response_402.additional_properties = d
        return send_message_v1_response_402
