...
from ..models.create_call_summary_webhook_v1_response_201_data_events_item import (
    CreateCallSummaryWebhookV1Response201DataEventsItem,
)
from ..models.create_call_summary_webhook_v1_response_201_data_status import (
    CreateCallSummaryWebhookV1Response201DataStatus,
)

T = TypeVar("T", bound="CreateCallSummaryWebhookV1Response201Data")


@_attrs_define
class CreateCallSummaryWebhookV1Response201Data:
    """
    Attributes:
        ...
        status (CreateCallSummaryWebhookV1Response201DataStatus): The status of the webhook. Default:
            CreateCallSummaryWebhookV1Response201DataStatus.ENABLED.
        ...
        events (list[CreateCallSummaryWebhookV1Response201DataEventsItem]):
    ...
    events: list[CreateCallSummaryWebhookV1Response201DataEventsItem]
    resource_ids: Union[list[Literal["*"]], list[str]]
    status: CreateCallSummaryWebhookV1Response201DataStatus = CreateCallSummaryWebhookV1Response201DataStatus.ENABLED
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = CreateCallSummaryWebhookV1Response201DataStatus(d.pop("status"))
        ...
        for events_item_data in _events:
            events_item = CreateCallSummaryWebhookV1Response201DataEventsItem(events_item_data)
        ...
        create_call_summary_webhook_v1_response_201_data = cls(
            id=id,
            user_id=user_id,
            org_id=org_id,
            label=label,
        ...
        create_call_summary_webhook_v1_response_201_data.additional_properties = d
        return create_call_summary_webhook_v1_response_201_data
