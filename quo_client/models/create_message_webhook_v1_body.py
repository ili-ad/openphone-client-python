...
from ..models.create_message_webhook_v1_body_events_item import CreateMessageWebhookV1BodyEventsItem
from ..models.create_message_webhook_v1_body_status import CreateMessageWebhookV1BodyStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="CreateMessageWebhookV1Body")


@_attrs_define
class CreateMessageWebhookV1Body:
    """
    Attributes:
        events (list[CreateMessageWebhookV1BodyEventsItem]):
        ...
        status (Union[Unset, CreateMessageWebhookV1BodyStatus]): The status of the webhook. Default:
            CreateMessageWebhookV1BodyStatus.ENABLED.
    ...
    status: Union[Unset, CreateMessageWebhookV1BodyStatus] = CreateMessageWebhookV1BodyStatus.ENABLED
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for events_item_data in _events:
            events_item = CreateMessageWebhookV1BodyEventsItem(events_item_data)
        ...
        status: Union[Unset, CreateMessageWebhookV1BodyStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = CreateMessageWebhookV1BodyStatus(_status)

        user_id = d.pop("userId", UNSET)

        create_message_webhook_v1_body = cls(
            events=events,
            url=url,
            label=label,
        ...
        create_message_webhook_v1_body.additional_properties = d
        return create_message_webhook_v1_body
