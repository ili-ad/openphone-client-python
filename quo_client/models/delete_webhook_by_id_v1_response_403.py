...
if TYPE_CHECKING:
    from ..models.delete_webhook_by_id_v1_response_403_errors_item import DeleteWebhookByIdV1Response403ErrorsItem


T = TypeVar("T", bound="DeleteWebhookByIdV1Response403")


@_attrs_define
class DeleteWebhookByIdV1Response403:
    """
    Attributes:
        message (str):
        ...
        errors (Union[Unset, list['DeleteWebhookByIdV1Response403ErrorsItem']]):
    """
    ...
    errors: Union[Unset, list["DeleteWebhookByIdV1Response403ErrorsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for errors_item_data in _errors or []:
            errors_item = DeleteWebhookByIdV1Response403ErrorsItem.from_dict(errors_item_data)

            errors.append(errors_item)

        delete_webhook_by_id_v1_response_403 = cls(
            message=message,
            code=code,
            status=status,
            docs=docs,
        ...
        delete_webhook_by_id_v1_response_403.additional_properties = d
        return delete_webhook_by_id_v1_response_403
