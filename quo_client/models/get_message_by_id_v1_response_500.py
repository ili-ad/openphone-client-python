...
if TYPE_CHECKING:
    from ..models.get_message_by_id_v1_response_500_errors_item import GetMessageByIdV1Response500ErrorsItem


T = TypeVar("T", bound="GetMessageByIdV1Response500")


@_attrs_define
class GetMessageByIdV1Response500:
    """
    Attributes:
        message (str):
        ...
        errors (Union[Unset, list['GetMessageByIdV1Response500ErrorsItem']]):
    """
    ...
    errors: Union[Unset, list["GetMessageByIdV1Response500ErrorsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for errors_item_data in _errors or []:
            errors_item = GetMessageByIdV1Response500ErrorsItem.from_dict(errors_item_data)

            errors.append(errors_item)

        get_message_by_id_v1_response_500 = cls(
            message=message,
            code=code,
            status=status,
            docs=docs,
        ...
        get_message_by_id_v1_response_500.additional_properties = d
        return get_message_by_id_v1_response_500
