...
from ..models.get_webhook_by_id_v1_response_200_data_type_0_events_item import (
    GetWebhookByIdV1Response200DataType0EventsItem,
)
from ..models.get_webhook_by_id_v1_response_200_data_type_0_status import GetWebhookByIdV1Response200DataType0Status

T = TypeVar("T", bound="GetWebhookByIdV1Response200DataType0")


@_attrs_define
class GetWebhookByIdV1Response200DataType0:
    """
    Attributes:
        ...
        status (GetWebhookByIdV1Response200DataType0Status): The status of the webhook. Default:
            GetWebhookByIdV1Response200DataType0Status.ENABLED.
        ...
        events (list[GetWebhookByIdV1Response200DataType0EventsItem]):
    ...
    events: list[GetWebhookByIdV1Response200DataType0EventsItem]
    resource_ids: Union[list[Literal["*"]], list[str]]
    status: GetWebhookByIdV1Response200DataType0Status = GetWebhookByIdV1Response200DataType0Status.ENABLED
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = GetWebhookByIdV1Response200DataType0Status(d.pop("status"))
        ...
        for events_item_data in _events:
            events_item = GetWebhookByIdV1Response200DataType0EventsItem(events_item_data)
        ...
        get_webhook_by_id_v1_response_200_data_type_0 = cls(
            id=id,
            user_id=user_id,
            org_id=org_id,
            label=label,
        ...
        get_webhook_by_id_v1_response_200_data_type_0.additional_properties = d
        return get_webhook_by_id_v1_response_200_data_type_0
