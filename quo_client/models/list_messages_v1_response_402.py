...
if TYPE_CHECKING:
    from ..models.list_messages_v1_response_402_errors_item import ListMessagesV1Response402ErrorsItem


T = TypeVar("T", bound="ListMessagesV1Response402")


@_attrs_define
class ListMessagesV1Response402:
    """
    Attributes:
        message (str):
        ...
        errors (Union[Unset, list['ListMessagesV1Response402ErrorsItem']]):
    """
    ...
    errors: Union[Unset, list["ListMessagesV1Response402ErrorsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for errors_item_data in _errors or []:
            errors_item = ListMessagesV1Response402ErrorsItem.from_dict(errors_item_data)

            errors.append(errors_item)

        list_messages_v1_response_402 = cls(
            message=message,
            code=code,
            status=status,
            docs=docs,
        ...
        list_messages_v1_response_402.additional_properties = d
        return list_messages_v1_response_402
