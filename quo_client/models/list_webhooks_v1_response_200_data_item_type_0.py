...
from ..models.list_webhooks_v1_response_200_data_item_type_0_events_item import (
    ListWebhooksV1Response200DataItemType0EventsItem,
)
from ..models.list_webhooks_v1_response_200_data_item_type_0_status import ListWebhooksV1Response200DataItemType0Status

T = TypeVar("T", bound="ListWebhooksV1Response200DataItemType0")


@_attrs_define
class ListWebhooksV1Response200DataItemType0:
    """
    Attributes:
        ...
        status (ListWebhooksV1Response200DataItemType0Status): The status of the webhook. Default:
            ListWebhooksV1Response200DataItemType0Status.ENABLED.
        ...
        events (list[ListWebhooksV1Response200DataItemType0EventsItem]):
    ...
    events: list[ListWebhooksV1Response200DataItemType0EventsItem]
    resource_ids: Union[list[Literal["*"]], list[str]]
    status: ListWebhooksV1Response200DataItemType0Status = ListWebhooksV1Response200DataItemType0Status.ENABLED
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = ListWebhooksV1Response200DataItemType0Status(d.pop("status"))
        ...
        for events_item_data in _events:
            events_item = ListWebhooksV1Response200DataItemType0EventsItem(events_item_data)
        ...
        list_webhooks_v1_response_200_data_item_type_0 = cls(
            id=id,
            user_id=user_id,
            org_id=org_id,
            label=label,
        ...
        list_webhooks_v1_response_200_data_item_type_0.additional_properties = d
        return list_webhooks_v1_response_200_data_item_type_0
