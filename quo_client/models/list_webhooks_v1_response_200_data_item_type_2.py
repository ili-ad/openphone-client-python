...
from ..models.list_webhooks_v1_response_200_data_item_type_2_events_item import (
    ListWebhooksV1Response200DataItemType2EventsItem,
)
from ..models.list_webhooks_v1_response_200_data_item_type_2_status import ListWebhooksV1Response200DataItemType2Status

T = TypeVar("T", bound="ListWebhooksV1Response200DataItemType2")


@_attrs_define
class ListWebhooksV1Response200DataItemType2:
    """
    Attributes:
        ...
        status (ListWebhooksV1Response200DataItemType2Status): The status of the webhook. Default:
            ListWebhooksV1Response200DataItemType2Status.ENABLED.
        ...
        events (list[ListWebhooksV1Response200DataItemType2EventsItem]):
    ...
    events: list[ListWebhooksV1Response200DataItemType2EventsItem]
    resource_ids: Union[list[Literal["*"]], list[str]]
    status: ListWebhooksV1Response200DataItemType2Status = ListWebhooksV1Response200DataItemType2Status.ENABLED
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = ListWebhooksV1Response200DataItemType2Status(d.pop("status"))
        ...
        for events_item_data in _events:
            events_item = ListWebhooksV1Response200DataItemType2EventsItem(events_item_data)
        ...
        list_webhooks_v1_response_200_data_item_type_2 = cls(
            id=id,
            user_id=user_id,
            org_id=org_id,
            label=label,
        ...
        list_webhooks_v1_response_200_data_item_type_2.additional_properties = d
        return list_webhooks_v1_response_200_data_item_type_2
