...
from ..models.list_webhooks_v1_response_200_data_item_type_3_events_item import (
    ListWebhooksV1Response200DataItemType3EventsItem,
)
from ..models.list_webhooks_v1_response_200_data_item_type_3_status import ListWebhooksV1Response200DataItemType3Status

T = TypeVar("T", bound="ListWebhooksV1Response200DataItemType3")


@_attrs_define
class ListWebhooksV1Response200DataItemType3:
    """
    Attributes:
        ...
        status (ListWebhooksV1Response200DataItemType3Status): The status of the webhook. Default:
            ListWebhooksV1Response200DataItemType3Status.ENABLED.
        ...
        events (list[ListWebhooksV1Response200DataItemType3EventsItem]):
    ...
    events: list[ListWebhooksV1Response200DataItemType3EventsItem]
    resource_ids: Union[list[Literal["*"]], list[str]]
    status: ListWebhooksV1Response200DataItemType3Status = ListWebhooksV1Response200DataItemType3Status.ENABLED
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = ListWebhooksV1Response200DataItemType3Status(d.pop("status"))
        ...
        for events_item_data in _events:
            events_item = ListWebhooksV1Response200DataItemType3EventsItem(events_item_data)
        ...
        list_webhooks_v1_response_200_data_item_type_3 = cls(
            id=id,
            user_id=user_id,
            org_id=org_id,
            label=label,
        ...
        list_webhooks_v1_response_200_data_item_type_3.additional_properties = d
        return list_webhooks_v1_response_200_data_item_type_3
